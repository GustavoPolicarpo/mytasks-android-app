...
import com.policarpo.mytasks.adapter.TaskItemTouchCallback
import com.policarpo.mytasks.adapter.TasksAdapter
import com.policarpo.mytasks.databinding.ActivityMainBinding
import com.policarpo.mytasks.entity.Task
import com.policarpo.mytasks.fragment.PreferenceFragment
import com.policarpo.mytasks.helper.NotificationHelper
import com.policarpo.mytasks.listener.TaskItemClickListener
import com.policarpo.mytasks.listener.TaskItemSwipeListener
...
//        helper.showNotification("Titulo da notificação 1", "Texto da notificação")
    ...
    private fun initComponents() {
        tasksAdapter = TasksAdapter(this, binding.tvMessage, object : TaskItemClickListener {
            override fun onClick(task: Task) {
                binding.etTitle?.let {
                    ...
                    val intent = Intent(this@MainActivity, com.policarpo.mytasks.activity.TaskFormActivity::class.java)
        ...
        binding.fabNewTask.setOnClickListener {
            startActivity(Intent(this, com.policarpo.mytasks.activity.TaskFormActivity::class.java))
